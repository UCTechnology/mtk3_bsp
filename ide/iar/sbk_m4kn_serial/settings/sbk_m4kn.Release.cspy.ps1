...
{
& "C:\Program Files\IAR Systems\Embedded Workbench 9.1_2\common\bin\cspybat" -f "C:\home\yura\_PROJECTS\uT3\uct_mtk3_bsp\ide\iar\sbk_m4kn_serial\settings\sbk_m4kn.Release.general.xcl" --debug_file=$debugfile --backend -f "C:\home\yura\_PROJECTS\uT3\uct_mtk3_bsp\ide\iar\sbk_m4kn_serial\settings\sbk_m4kn.Release.driver.xcl" 
}
