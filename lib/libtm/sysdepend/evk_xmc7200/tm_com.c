...
{
const BRDTBL brdTbl[] = {
	{115200, 212   }, {57600,   424 }, {38400,  634 },
	{ 19200, 1275  }, { 9600,  2551 }, { 4800, 5103 },
	{  2400, 10207 }, { 1200, 20415 }, {0, 0}	};
	INT idx;
	UW div_val = 0;
	...
	if( brdTbl[idx].baud == 0 )	// baud is not support
	{
		idx = 0;		// Default = 115200 bps
	}
	div_val = brdTbl[idx].dv;
