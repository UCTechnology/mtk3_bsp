...
#ifndef __ETHER_BASE_H__
#define __ETHER_BASE_H__
 ...
 */
#define ETHER_RECV_TASK_STACK_SIZE (2048)
...
#define ETHER_FLGPTN_RECV (0x01)
#define ETHER_FLGPTN_SEND (0x02)
#define ETHER_FLGPTN_MII  (0x80)
#endif
/*
 * Constants for device information
 */
#if 0   /* stm32h723 */
#define ETHER_DEVINFO_DEVNAME "NUCLEO-H723ZG"
#define ETHER_DEVINFO_IOBASE (0x40028000UL) /* The beginning address of Ethernet module registers. */
#define ETHER_DEVINFO_IOSIZE (512)
#define ETHER_DEVINFO_INTNO  (61) /* Interrupt vector of the Ethernet interrupt.*/
#define ETHER_DEVINFO_IFCONN (IFC_AUTO)
#else
#define ETHER_DEVINFO_DEVNAME "AdBun-TMPM4NR"
#define ETHER_DEVINFO_IOBASE (ETHMA_BASE) /* The beginning address of EtherMAC module registers. */
#define ETHER_DEVINFO_IOSIZE (512)
#define ETHER_DEVINFO_INTNO  (ETH_VECTOR) /* Interrupt vector of the transmit interrupt. */
#define ETHER_DEVINFO_IFCONN (IFC_AUTO)
#endif
