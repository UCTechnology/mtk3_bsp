...
#ifndef	__DEV_SER_M4KN_H__
#define	__DEV_SER_M4KN_H__

/*----------------------------------------------------------------------*/
/*	Device Configurations						*/
/*----------------------------------------------------------------------*/
#define	DEV_SER_UNITNM		(4)		/* Number of devive channels */
...
IMPORT CONST UW ba[DEV_SER_UNITNM];		/* ser_m4kn.c		*/
 ...
 * UART Interrupts
 */
#define UART0_RX_IRQ_NUMBER	60	/* BASE		*/
#define UART0_TX_IRQ_NUMBER	61	/* BASE	+ 1	*/
#define UART0_ER_IRQ_NUMBER	62	/* BASE + 2	*/
#define UART1_RX_IRQ_NUMBER	63	/* BASE		*/
#define UART1_TX_IRQ_NUMBER	64	/* BASE	+ 1	*/
#define UART1_ER_IRQ_NUMBER	65	/* BASE + 2	*/
#define UART2_RX_IRQ_NUMBER	66	/* BASE		*/
#define UART2_TX_IRQ_NUMBER	67	/* BASE	+ 1	*/
#define UART2_ER_IRQ_NUMBER	68	/* BASE + 2	*/
#define UART3_RX_IRQ_NUMBER	69	/* BASE		*/
#define UART3_TX_IRQ_NUMBER	70	/* BASE	+ 1	*/
#define UART3_ER_IRQ_NUMBER	71	/* BASE + 2	*/
...
/*		--> lib/libtm/sysdepend/sbk_m4kn/tm_com.c		*/
/*----------------------------------------------------------------------*/
...
const	BRDTBL	brdTbl[] = {	 /* baud  KEN BRK     BRN */
	{115200, 1, 26,   43 }, {57600, 1, 52,   86 }, {38400, 1, 13,  130 },
	{ 19200, 1, 27,  260 }, { 9600, 1, 53,  520 }, { 4800, 1, 43, 1041 },
	{  2400, 1, 21, 2083 }, { 1200, 1, 43, 4166 }, {0,0,0,0}  };
	INT	idx;
