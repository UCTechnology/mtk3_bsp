...
#ifndef	__DEV_SER_M4MN_H__
#define	__DEV_SER_M4MN_H__
...
IMPORT CONST UW ba[DEV_SER_UNITNM];		/* ser_m4mn.c		*/
...
/*		--> lib/libtm/sysdepend/sbk_m4mn/tm_com.c		*/
/*----------------------------------------------------------------------*/
