 ...
 *	Interrupt processing for TMPM4KN
 */
...
LOCAL	const	UW	uart_IRQ_tx[DEV_SER_UNITNM] = {
	UART0_TX_IRQ_NUMBER, UART1_TX_IRQ_NUMBER, UART2_TX_IRQ_NUMBER, UART3_TX_IRQ_NUMBER, UART4_TX_IRQ_NUMBER, UART5_TX_IRQ_NUMBER,
};
LOCAL	const	UW	uart_IRQ_rx[DEV_SER_UNITNM] = {
	UART0_RX_IRQ_NUMBER, UART1_RX_IRQ_NUMBER, UART2_RX_IRQ_NUMBER, UART3_RX_IRQ_NUMBER, UART4_RX_IRQ_NUMBER, UART5_RX_IRQ_NUMBER,
};
LOCAL	const	UW	uart_IRQ_err[DEV_SER_UNITNM] = {
	UART0_ER_IRQ_NUMBER, UART1_ER_IRQ_NUMBER, UART2_ER_IRQ_NUMBER, UART3_ER_IRQ_NUMBER, UART4_ER_IRQ_NUMBER, UART5_ER_IRQ_NUMBER,
};
...
const	INT	level_tx[DEV_SER_UNITNM] = {
			...
			INTPRI_GROUP(UART4_TX_IRQ_PRI, UART4_TX_IRQ_SUBPRI),
			INTPRI_GROUP(UART5_TX_IRQ_PRI, UART5_TX_IRQ_SUBPRI),
		};
const	INT	level_rx[DEV_SER_UNITNM] = {
			...
			INTPRI_GROUP(UART3_TX_IRQ_PRI, UART3_TX_IRQ_SUBPRI),
			INTPRI_GROUP(UART4_TX_IRQ_PRI, UART3_TX_IRQ_SUBPRI),
			INTPRI_GROUP(UART5_TX_IRQ_PRI, UART3_TX_IRQ_SUBPRI),
		};
const	INT	level_err[DEV_SER_UNITNM] = {
			...
			INTPRI_GROUP(UART4_ERR_IRQ_PRI, UART3_ERR_IRQ_SUBPRI),
			INTPRI_GROUP(UART5_ERR_IRQ_PRI, UART3_ERR_IRQ_SUBPRI),
		};
...
LOCAL	void	uart4TxInthdr( UINT intno ){ uartTxInthdr(4); };
LOCAL	void	uart5TxInthdr( UINT intno ){ uartTxInthdr(5); };
...
LOCAL	void	uart4RxInthdr( UINT intno ){ uartRxInthdr(4); };
LOCAL	void	uart5RxInthdr( UINT intno ){ uartRxInthdr(5); };
...
LOCAL	void	uart4ErrInthdr( UINT intno ){ uartErrInthdr(4); };
LOCAL	void	uart5ErrInthdr( UINT intno ){ uartErrInthdr(5); };
...
const	FP	UART_InthdrTx[DEV_SER_UNITNM] = {
		(FP)uart0TxInthdr, (FP)uart1TxInthdr, (FP)uart2TxInthdr, (FP)uart3TxInthdr, (FP)uart4TxInthdr, (FP)uart5TxInthdr,
	};
const	FP	UART_InthdrRx[DEV_SER_UNITNM] = {
		(FP)uart0RxInthdr, (FP)uart1RxInthdr, (FP)uart2RxInthdr, (FP)uart3RxInthdr, (FP)uart4RxInthdr, (FP)uart5RxInthdr,
	};
const	FP	UART_InthdrErr[DEV_SER_UNITNM] = {
		(FP)uart0ErrInthdr, (FP)uart1ErrInthdr, (FP)uart2ErrInthdr, (FP)uart3ErrInthdr, (FP)uart4ErrInthdr, (FP)uart5ErrInthdr,
	};
