...
#ifndef	__DEV_SER_M4GR_H__
#define	__DEV_SER_M4GR_H__
...
IMPORT CONST UW ba[DEV_SER_UNITNM];		/* ser_m4gr.c		*/
...
/*		--> lib/libtm/sysdepend/sbk_m4gr/tm_com.c		*/
/*----------------------------------------------------------------------*/
