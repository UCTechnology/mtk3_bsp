 ...
 *	sysdef.h
 *
 *	System dependencies definition (TMPM4MN depended)
...
/* TMPM4MN Internal RAM0/1/2   0x20000000 to 0x20006000  (Size 24KB = 8KB+8KB+8KB) */
#if CPU_M4MN
#define INTERNAL_RAM_SIZE       (0x20006000-0x20000000)
...
#define CGFSYSMENA_T32A3	0x80000000ul	/* T32A ch3 enable */
#define CGFSYSMENA_T32A2	0x40000000ul	/* T32A ch2 enable */
#define CGFSYSMENA_T32A1	0x20000000ul	/* T32A ch1 enable */
#define CGFSYSMENA_T32A0	0x10000000ul	/* T32A ch0 enable */

#define CGFSYSMENA_UART3	0x01000000ul	/* UART ch3 enable */
#define CGFSYSMENA_UART2	0x00800000ul	/* UART ch2 enable */
#define CGFSYSMENA_UART1	0x00400000ul	/* UART ch1 enable */
#define CGFSYSMENA_UART0	0x00200000ul	/* UART ch0 enable : CONSOLE */

#define CGFSYSMENA_PV		0x00020000ul	/* Port V enable : LED4,5 */
#define CGFSYSMENA_PU		0x00010000ul	/* Port U enable */
#define CGFSYSMENA_PN		0x00001000ul	/* Port N enable */
#define CGFSYSMENA_PM		0x00000800ul	/* Port M enable */
#define CGFSYSMENA_PL		0x00000400ul	/* Port L enable */
#define CGFSYSMENA_PK		0x00000200ul	/* Port K enable */
#define CGFSYSMENA_PJ		0x00000100ul	/* Port J enable */
#define CGFSYSMENA_PH		0x00000080ul	/* Port H enable */
#define CGFSYSMENA_PG		0x00000040ul	/* Port G enable */
#define CGFSYSMENA_PF		0x00000020ul	/* Port F enable */
#define CGFSYSMENA_PE		0x00000010ul	/* Port E enable */
#define CGFSYSMENA_PD		0x00000008ul	/* Port D enable */
#define CGFSYSMENA_PC		0x00000004ul	/* Port C enable : UART0 PC0=TxD, PC1=RxD */
#define CGFSYSMENA_PB		0x00000002ul	/* Port B enable : LED1,2,3,6 */
#define CGFSYSMENA_PA		0x00000001ul	/* Port A enable */
...
/*
 * Watch Dog Timer
 * TMPM4MN has only ch0.		TYPE2 : "PINFO-M4M(1)" (p.46)
 */
 ...
 */
#define N_INTVEC		125	/* Number of Interrupt vectors */
 ...
 */
#define PC0_UT0TXDA		1			/* PCFR1: UT0TXDA */
#define PC1_UT0RXD		1			/* PCFR1: UT0RXD */
